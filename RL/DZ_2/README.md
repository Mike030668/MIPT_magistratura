# Реализации DDQN с дополнительной памятью
...
<img src='images/vizdoom.png' width='350'>  <img src='images/videoframe_16600.png' width='350'>
...
- рейтинг учитывает, было ли действие случайое или от действия самой сети, что зависит от эпсилон, котрыйй постепенно снижается в обучении. Тем самым вес у случайного действия или осозноного разный и попадают в буфер случайные действия только с заведомо высоким рейтингом.
...
- если сумарный рейтинг всего стека превысил текущий порог, то обновлем целевую в этот момент, внепланово.
...
# Текущее состояние сети уже может выдавать поажение 20-22 противников и способно учиться далее.
